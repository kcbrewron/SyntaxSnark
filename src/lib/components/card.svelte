<script>
    ...
    import ThumbsUpIcon from "./ui/ThumbsUpIcon.svelte";
...
<Card class="bg-gray-100 rounded-lg border-y-orange-500 border-y-4 border-x-transparent hover:drop-shadow-lg flex flex-col h-full mb-4">
    {#snippet children()}
            ...
            <div class="space-y-4">
                ...
                {#if comment.categories && comment.categories.length > 0}
                    <div class="flex flex-wrap gap-1">
                        {#each comment.categories as category, i (i)}
